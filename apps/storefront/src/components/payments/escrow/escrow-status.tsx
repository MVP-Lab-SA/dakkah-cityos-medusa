    ...
    <div className="bg-ds-background rounded-xl border border-ds-border overflow-hidden">
      <div className="p-6">
        <div className="flex items-start justify-between mb-6">
          <div>
            <p className="text-sm text-ds-muted-foreground">{t(locale, "escrow.title")}</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {heldSince && (
            <div className="bg-ds-muted rounded-lg p-3">
              <p className="text-xs text-ds-muted-foreground mb-1">{t(locale, "escrow.held_since")}</p>
          ...
          {releaseDate && (
            <div className="bg-ds-muted rounded-lg p-3">
              <p className="text-xs text-ds-muted-foreground mb-1">{t(locale, "escrow.release_date")}</p>
              <p className="text-sm font-medium text-ds-foreground">
      ...
      <div className="border-t border-ds-border bg-ds-muted/30 px-6 py-4">
        <div className="grid grid-cols-2 gap-4 text-sm">
          <div>
            <p className="text-xs text-ds-muted-foreground mb-0.5">{t(locale, "escrow.buyer")}</p>
            <p className="font-medium text-ds-foreground">{parties.buyer}</p>
          </div>
          <div>
            <p className="text-xs text-ds-muted-foreground mb-0.5">{t(locale, "escrow.seller")}</p>

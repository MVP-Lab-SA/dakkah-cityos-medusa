  ...
  return (
    <div className="bg-ds-background rounded-lg border border-ds-border p-4">
      <div className="flex items-center justify-between mb-3">
        <h4 className="text-sm font-semibold text-ds-foreground">{t(locale, "storeCredits.apply_credit")}</h4>
        <span className="text-sm text-ds-muted-foreground">
          {t(locale, "storeCredits.balance")}: {formatCurrency(balance, currency, loc)}
        </span>
      </div>
      ...
      {isApplied ? (
        <div className="flex items-center justify-between bg-ds-success/10 rounded-lg px-4 py-3">
          <div>
            <p className="text-sm font-medium text-ds-success">{t(locale, "storeCredits.credit_applied")}</p>
        ...
        <div className="flex items-center gap-2">
          <div className="relative flex-1">
            <input
              ...
              placeholder={t(locale, "storeCredits.amount_to_apply")}

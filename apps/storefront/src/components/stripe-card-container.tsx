    ...
    <>
      {isSelected && (
        <div className="my-4 transition-all duration-150 ease-in-out">
          <p className="text-base font-semibold text-ds-foreground mb-4">
          ...
          <div className="space-y-4 flex flex-wrap">
            <div>
              ...
              />
              {cardBrand && (
                <p className="text-sm text-ds-foreground">{cardBrand}</p>
              )}
            </div>
          ...
          <div className="mt-3 text-xs text-ds-muted-foreground">

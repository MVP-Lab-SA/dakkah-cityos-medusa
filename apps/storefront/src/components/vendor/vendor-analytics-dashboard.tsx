      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="border rounded-lg p-6">
          ...
          {trends?.revenue_change !== undefined && (
            <div className={`flex items-center gap-1 mt-2 text-sm ${
              trends.revenue_change >= 0 ? "text-green-600" : "text-red-600"
            }`}>
        ...
        <div className="border rounded-lg p-6">
          ...
          {trends?.orders_change !== undefined && (
            <div className={`flex items-center gap-1 mt-2 text-sm ${
              trends.orders_change >= 0 ? "text-green-600" : "text-red-600"
            }`}>
        ...
        <div className="border rounded-lg p-6">
          <p className="text-sm text-zinc-500 mb-1">Commission Paid</p>
        ...
        <div className="border rounded-lg p-6">
          <p className="text-sm text-zinc-500 mb-1">Net Earnings</p>
                ...
                <div key={product.product_id} className="px-6 py-4 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-zinc-500">{product.units_sold} units sold</p>
                    </div>
                  </div>
            ...
            <div className="divide-y">
              {data.recent_orders.map((order) => (
                <div key={order.id} className="px-6 py-4 flex items-center justify-between">
                  <div>
                    <p className="font-medium text-zinc-900">Order #{order.display_id}</p>

        ...
        <div className="flex items-center justify-between px-4 py-3 border-t border-ds-border">
          ...
          <div className="flex items-center gap-1">
            <button
              ...
              className="inline-flex items-center justify-center w-8 h-8 rounded-md text-ds-muted-foreground hover:bg-ds-muted disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
            >
              <ChevronLeft className="w-4 h-4" />
            </button>
            <span className="text-xs text-ds-muted-foreground px-2">
              {page + 1} / {totalPages}
            </span>
            <button
              type="button"

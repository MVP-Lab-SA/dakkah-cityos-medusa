    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <span className={`px-2 py-1 rounded text-xs font-medium ${
            company.status === "active" ? "bg-ds-success text-ds-success" :
            company.status === "pending" ? "bg-ds-warning text-ds-warning" :
            company.status === "suspended" ? "bg-ds-destructive text-ds-destructive" :
      ...
      {company.status === "pending" && (
        <div className="bg-ds-warning border border-ds-warning rounded-lg p-4 flex items-start gap-3">
          ...
          <div>
            <h3 className="font-semibold text-ds-warning">Account Pending Approval</h3>

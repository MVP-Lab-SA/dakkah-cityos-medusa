...
export const Route = createFileRoute("/$tenant/$locale/places/")({
  ...
  loader: async () => {
    try {
      const places = [
        { id: "1", name: "Grand Mosque (Masjid al-Haram)", description: t(locale, "places.description1_the_largest_mosque_i", "The largest mosque in the world, surrounding Islam's holiest place, the Kaaba in Mecca."), category: "Religious", rating: 4.9, reviews: 12500, location: "Mecca, Saudi Arabia", image: "https://images.unsplash.com/photo-1591604129939-f1efa4d9f7fa?w=400&h=300&fit=crop" },
        { id: "2", name: "Souq Al-Zal", description: t(locale, "places.description2_historic_marketplace", "Historic marketplace in Riyadh known for traditional crafts, antiques, and authentic Arabian goods."), category: "Shopping", rating: 4.5, reviews: 3200, location: "Riyadh, Saudi Arabia", image: "https://images.unsplash.com/photo-1578895101408-1a36b834405b?w=400&h=300&fit=crop" },
        { id: "3", name: "Kingdom Tower", description: t(locale, "places.description3_iconic_99_floor_skys", "Iconic 99-floor skyscraper with a sky bridge offering panoramic views of Riyadh's skyline."), category: "Landmark", rating: 4.7, reviews: 8900, location: "Riyadh, Saudi Arabia", image: "https://images.unsplash.com/photo-1586724237569-f3d0c1dee8c6?w=400&h=300&fit=crop" },
        { id: "4", name: "Al Masmak Fort", description: t(locale, "places.description4_historic_clay_and_mu", "Historic clay and mud-brick fortress that played a key role in the founding of Saudi Arabia."), category: "Historical", rating: 4.6, reviews: 5600, location: "Riyadh, Saudi Arabia", image: "https://images.unsplash.com/photo-1578469550956-0e16b69c6a3d?w=400&h=300&fit=crop" },
        { id: "5", name: "Edge of the World", description: t(locale, "places.description5_dramatic_cliff_forma", "Dramatic cliff formation northwest of Riyadh offering breathtaking views of the endless desert."), category: "Nature", rating: 4.8, reviews: 4200, location: "Riyadh Province, Saudi Arabia", image: "https://images.unsplash.com/photo-1682687220742-aba13b6e50ba?w=400&h=300&fit=crop" },
        { id: "6", name: "Al-Ula Heritage Village", description: t(locale, "places.description6_ancient_village_with", "Ancient village with remarkable rock formations and the UNESCO World Heritage site of Hegra."), category: "Heritage", rating: 4.9, reviews: 6700, location: "Al-Ula, Saudi Arabia", image: "https://images.unsplash.com/photo-1632321757486-66b4a4e7a627?w=400&h=300&fit=crop" },
        { id: "7", name: "Jeddah Corniche", description: t(locale, "places.description7_beautiful_waterfront", "Beautiful waterfront promenade stretching along the Red Sea with parks, sculptures, and dining."), category: "Leisure", rating: 4.4, reviews: 7800, location: "Jeddah, Saudi Arabia", image: "https://images.unsplash.com/photo-1580060839134-75a5edca2e99?w=400&h=300&fit=crop" },
        { id: "8", name: "Diriyah", description: t(locale, "places.description8_historic_seat_of_the", "Historic seat of the first Saudi state, now a cultural destination with museums and restaurants."), category: "Heritage", rating: 4.7, reviews: 4500, location: "Riyadh, Saudi Arabia", image: "https://images.unsplash.com/photo-1586724237569-f3d0c1dee8c6?w=400&h=300&fit=crop" },
      ]
      return { places }
    } catch {
      return { places: [] }

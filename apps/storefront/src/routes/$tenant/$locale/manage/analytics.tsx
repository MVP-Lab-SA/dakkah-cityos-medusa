      ...
      <Container>
        ...
        <SectionCard title={t(locale, "manage.revenue_over_time")}>
          <div className="h-64 flex items-center justify-center border border-dashed border-gray-200 rounded-lg bg-gray-50">
            <div className="text-center space-y-2">
              <ChartBar className="w-8 h-8 text-gray-400 mx-auto" />
              <p className="text-sm text-gray-400">{t(locale, "manage.revenue_over_time")}</p>
            </div>
          </div>
        </SectionCard>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <SectionCard title={t(locale, "manage.top_products")}>
            <p className="text-sm text-gray-400 text-center py-8">{t(locale, "manage.no_products")}</p>
          </SectionCard>
          ...
          <SectionCard title={t(locale, "manage.customer_stats")}>
            <div className="grid grid-cols-2 gap-4">
              <div className="p-4 bg-gray-50 rounded-lg text-center">
                ...
                <p className="text-xs text-gray-400 mt-1">{t(locale, "manage.new_customers")}</p>
              </div>
              <div className="p-4 bg-gray-50 rounded-lg text-center">
                <p className="text-2xl font-bold text-gray-900">0</p>
                <p className="text-xs text-gray-400 mt-1">{t(locale, "manage.returning_customers")}</p>
              </div>
            </div>
          </SectionCard>
        </div>

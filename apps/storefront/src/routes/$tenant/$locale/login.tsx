    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-ds-foreground">Welcome back</h1>
          <p className="mt-2 text-ds-muted-foreground">Sign in to your account to continue</p>
        </div>
        ...
        <div className="mt-8 text-center space-y-4">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-ds-muted text-ds-muted-foreground">Or continue with</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <Link
              ...
              className="flex items-center justify-center px-4 py-3 border border-ds-border rounded-lg hover:bg-ds-muted transition-colors"
            >
              <span className="text-sm font-medium text-ds-foreground">Become a Vendor</span>
            </Link>
          </div>
        </div>
      </div>

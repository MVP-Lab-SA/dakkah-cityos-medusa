      ...
      <div className="min-h-screen bg-ds-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="bg-ds-background border border-ds-border rounded-xl p-12 text-center">
            ...
            <h2 className="text-xl font-semibold text-ds-foreground mb-2">Item Not Found</h2>
            <p className="text-ds-muted-foreground mb-6">This consignment item may have been sold or is no longer available.</p>
            <Link to={`${prefix}/consignment` as any} className="inline-flex items-center px-4 py-2 text-sm font-medium bg-ds-primary text-ds-primary-foreground rounded-lg hover:bg-ds-primary/90 transition-colors">
              Browse Consignment
            </Link>
          </div>
        </div>
      ...
      <div className="bg-ds-card border-b border-ds-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center gap-2 text-sm text-ds-muted-foreground">
            ...
            <span>/</span>
            <Link to={`${prefix}/consignment` as any} className="hover:text-ds-foreground transition-colors">Consignment</Link>
            <span>/</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="flex flex-wrap gap-4 text-sm text-ds-muted-foreground">
              ...
              {item.consignor && (
                <div className="flex items-center gap-1.5">
                  ...
                  <span>By {typeof item.consignor === "object" ? item.consignor.name : item.consignor}</span>
                </div>
              )}
              {item.created_at && (
                <div className="flex items-center gap-1.5">
          ...
          <aside className="space-y-6">
            <div className="sticky top-4 space-y-6">
              ...
              <div className="bg-ds-background border border-ds-border rounded-xl p-6">
                <h3 className="font-semibold text-ds-foreground mb-3">Consignment Info</h3>

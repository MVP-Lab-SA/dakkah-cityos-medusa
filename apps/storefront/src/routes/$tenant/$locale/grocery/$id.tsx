                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                  {product.related_products.map((related: any, idx: number) => (
                    <div key={idx} className="p-3 border border-ds-border rounded-lg">
                      ...
                      {related.price != null && <p className="text-sm text-ds-primary font-bold mt-1">${Number(related.price).toFixed(2)}</p>}
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="bg-ds-background border border-ds-border rounded-xl p-6 space-y-4">
                {product.price != null && (
                  <div className="text-center">
                    <p className="text-3xl font-bold text-ds-foreground">${Number(product.price).toFixed(2)}</p>

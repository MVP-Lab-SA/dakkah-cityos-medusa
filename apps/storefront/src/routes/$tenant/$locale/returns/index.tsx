    ...
    <div className="min-h-screen bg-ds-background">
      <div className="bg-gradient-to-r from-ds-destructive to-rose-600 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-white/80 max-w-2xl mx-auto">Easy, hassle-free returns with free shipping. Get your refund within 5-7 business days.</p>
          <div className="mt-6 flex items-center justify-center gap-4 text-sm text-white/60">
            <span>{t(locale, "returns.badge_30_day", "30-day returns")}</span><span>|</span><span>{t(locale, "returns.badge_free_return_shipping", "Free return shipping")}</span><span>|</span><span>{t(locale, "returns.badge_fast_refunds", "Fast refunds")}</span>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <h2 className="text-2xl font-bold text-ds-foreground mb-6">Return Policy</h2>
        ...
        <h2 className="text-2xl font-bold text-ds-foreground mb-6">Frequently Asked Questions</h2>
        {faqs.length === 0 ? (
          <div className="bg-ds-background border border-ds-border rounded-xl p-12 text-center">
            <h3 className="text-lg font-semibold text-ds-foreground mb-2">No FAQs available</h3>
            <p className="text-ds-muted-foreground text-sm">Check back later for updates.</p>
          </div>
        ) : (

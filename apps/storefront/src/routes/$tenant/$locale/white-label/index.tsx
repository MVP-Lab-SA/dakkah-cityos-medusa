  ...
  return (
    <div className="min-h-screen bg-ds-background">
      <div className="bg-gradient-to-r from-ds-primary to-ds-primary/80 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-6 flex items-center justify-center gap-4 text-sm text-white/60">
            <span>{t(locale, "whiteLabel.badge_brand_control", "Full brand control")}</span><span>|</span><span>{t(locale, "whiteLabel.badge_custom_domain", "Custom domain")}</span><span>|</span><span>{t(locale, "whiteLabel.badge_mobile_apps", "Mobile apps")}</span>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <h2 className="text-2xl font-bold text-ds-foreground mb-6">Feature Comparison</h2>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-ds-border bg-ds-muted/50">
                  <th className="text-left p-4 font-semibold text-ds-foreground">Feature</th>
                  <th className="text-center p-4 font-semibold text-ds-foreground">Starter</th>
                  <th className="text-center p-4 font-semibold text-ds-foreground">Business</th>
                  <th className="text-center p-4 font-semibold text-ds-foreground">Enterprise</th>
                </tr>
              </thead>
              <tbody>
                {comparisons.map((row: any, i: number) => (
                  <tr key={i} className="border-b border-ds-border last:border-0">
                    <td className="p-4 text-ds-foreground font-medium">{row.feature}</td>

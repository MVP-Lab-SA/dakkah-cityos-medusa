            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
              ...
              {service.fee != null && (
                <div className="bg-ds-background border border-ds-border rounded-xl p-4 text-center">
                  ...
                  <p className="text-lg font-bold text-ds-foreground">{Number(service.fee) === 0 ? "Free" : `$${Number(service.fee).toLocaleString()}`}</p>
                </div>
              )}
              ...
              <div className="bg-ds-background border border-ds-border rounded-xl p-6 space-y-4">
                {service.fee != null && (
                  <div className="text-center">
                    <p className="text-3xl font-bold text-ds-foreground">{Number(service.fee) === 0 ? "Free" : `$${Number(service.fee).toLocaleString()}`}</p>

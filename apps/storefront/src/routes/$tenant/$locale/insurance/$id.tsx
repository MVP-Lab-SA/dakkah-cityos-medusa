            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {plan.premium != null && (
                <div className="bg-ds-background border border-ds-border rounded-xl p-4 text-center">
                  ...
                  <p className="text-lg font-bold text-ds-foreground">${Number(plan.premium).toLocaleString()}</p>
              ...
              {plan.deductible != null && (
                <div className="bg-ds-background border border-ds-border rounded-xl p-4 text-center">
                  ...
                  <p className="text-lg font-bold text-ds-foreground">${Number(plan.deductible).toLocaleString()}</p>
                </div>
              )}
              {plan.coverage_amount != null && (
                <div className="bg-ds-background border border-ds-border rounded-xl p-4 text-center">
                  <p className="text-xs text-ds-muted-foreground mb-1">Coverage</p>
                  <p className="text-lg font-bold text-ds-foreground">${Number(plan.coverage_amount).toLocaleString()}</p>
                </div>
              )}
              {plan.rating && (
                <div className="bg-ds-background border border-ds-border rounded-xl p-4 text-center">
              ...
              <div className="bg-ds-background border border-ds-border rounded-xl p-6 space-y-4">
                {plan.premium != null && (
                  <div className="text-center">
                    <p className="text-3xl font-bold text-ds-foreground">${Number(plan.premium).toLocaleString()}</p>

...
export const Route = createFileRoute("/$tenant/$locale/gift-cards-shop/")({
  ...
  loader: async () => {
    try {
      ...
      const resp = await fetch(`${baseUrl}/store/gift-cards`, {
        headers: {
      ...
      <div className="bg-gradient-to-r from-ds-destructive to-ds-primary text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-white/80 max-w-2xl mx-auto">
            The perfect gift for every occasion — choose a design and denomination that speaks from the heart.
          </p>
          <div className="mt-6 flex items-center justify-center gap-4 text-sm text-white/60">
            <span>{items.length} designs available</span>
            <span>|</span>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          <aside className="w-full lg:w-72 flex-shrink-0">
            <div className="bg-ds-background border border-ds-border rounded-xl p-4 space-y-6 sticky top-4">
              ...
              <div>
                <label className="block text-sm font-medium text-ds-foreground mb-2">Theme</label>

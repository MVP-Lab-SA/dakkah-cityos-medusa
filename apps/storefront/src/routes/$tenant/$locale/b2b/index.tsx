...
const fallbackItems = [
  { id: "b2b-1", company_name: "TechVision Solutions", industry: "technology", thumbnail: "https://images.unsplash.com/photo-1497366216548-37526070297c?w=600&q=80", description: "Enterprise software solutions, cloud infrastructure, and IT consulting for businesses of all sizes.", location: "San Francisco, CA", established: 2012, employees: 450, products_services: ["Cloud hosting", "SaaS platforms", "IT consulting", "Cybersecurity"] },
  { id: "b2b-2", company_name: "BuildPro Construction", industry: "construction", thumbnail: "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=600&q=80", description: "Commercial and residential construction, project management, and architectural design services.", location: "Chicago, IL", established: 1998, employees: 1200, products_services: ["Commercial building", "Renovation", "Project management", "Green construction"] },
  { id: "b2b-3", company_name: "Grandview Hospitality", industry: "hospitality", thumbnail: "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=600&q=80", description: "Premium hotel management, event catering, and hospitality training programs.", location: "Miami, FL", established: 2005, employees: 800, products_services: ["Hotel management", "Event catering", "Staff training", "Restaurant consulting"] },
  { id: "b2b-4", company_name: "FreshSource Foods", industry: "food", thumbnail: "https://images.unsplash.com/photo-1606787366850-de6330128bfc?w=600&q=80", description: "Wholesale organic food distribution, cold chain logistics, and private label food manufacturing.", location: "Portland, OR", established: 2010, employees: 350, products_services: ["Organic wholesale", "Cold chain logistics", "Private label", "Food safety consulting"] },
  { id: "b2b-5", company_name: "MedEquip International", industry: "medical", thumbnail: "https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=600&q=80", description: "Medical equipment manufacturing, hospital supply chain, and healthcare technology solutions.", location: "Boston, MA", established: 2001, employees: 600, products_services: ["Medical devices", "Hospital supplies", "Telemedicine", "Lab equipment"] },
  { id: "b2b-6", company_name: "DataStream Analytics", industry: "technology", thumbnail: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=600&q=80", description: "Big data analytics, business intelligence dashboards, and AI-powered predictive modeling.", location: "Austin, TX", established: 2015, employees: 180, products_services: ["Data analytics", "BI dashboards", "AI/ML solutions", "Data warehousing"] },
]
...
export const Route = createFileRoute("/$tenant/$locale/b2b/")({
  ...
  loader: async () => {
    try {
      ...
      const raw = data.items || data.companies || data.suppliers || data.listings || []
...
const industryOptions = ["all", "technology", "construction", "hospitality", "food", "medical"] as const
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          <aside className="w-full lg:w-72 flex-shrink-0">
            <div className="bg-ds-background border border-ds-border rounded-xl p-4 space-y-6 sticky top-4">
              ...
              <div>
                <label className="block text-sm font-medium text-ds-foreground mb-2">{t(locale, 'verticals.industry_label')}</label>
                <div className="space-y-1">
                  {industryOptions.map((opt) => (
                    <button key={opt} onClick={() => setIndustryFilter(opt)} className={`block w-full text-start px-3 py-2 text-sm rounded-lg transition-colors ${industryFilter === opt ? "bg-ds-primary text-ds-primary-foreground" : "text-ds-foreground hover:bg-ds-muted"}`}>
                      {opt === "all" ? t(locale, 'verticals.all_industries') : opt.charAt(0).toUpperCase() + opt.slice(1)}
                    </button>
                  ))}
                </div>
              </div>

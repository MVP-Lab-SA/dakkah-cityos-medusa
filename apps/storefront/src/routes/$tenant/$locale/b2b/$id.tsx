        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
            <div className="relative aspect-[16/9] bg-ds-muted rounded-xl overflow-hidden">
              ...
              {item.verified && (
                <span className="absolute top-4 start-4 px-3 py-1 text-xs font-semibold rounded-full bg-blue-600 text-white flex items-center gap-1">
              ...
              <div className="bg-ds-background border border-ds-border rounded-xl p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {item.certifications.map((cert: string, idx: number) => (
                    <span key={idx} className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-full bg-blue-50 text-blue-700 border border-blue-200">

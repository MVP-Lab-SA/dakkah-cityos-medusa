    ...
    <div className="container mx-auto py-12">
      ...
      {items.length === 0 ? (
        <div className="text-center py-16 text-ds-muted-foreground">
          ...
          <p className="text-sm">Create your first volume deal to offer bulk pricing discounts to buyers.</p>
        </div>
      ) : (
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-3 mb-3">
                      <div className="bg-ds-muted/50 rounded-lg p-3 text-center">
                        <p className="text-lg font-bold">{deal.min_order_qty}</p>
                        <p className="text-xs text-ds-muted-foreground">Min Qty</p>
                      </div>
                      <div className="bg-ds-muted/50 rounded-lg p-3 text-center">
                        <p className="text-lg font-bold">{deal.max_discount_percent}%</p>
                        <p className="text-xs text-ds-muted-foreground">Max Discount</p>
                      </div>
                      <div className="bg-ds-muted/50 rounded-lg p-3 text-center">
                      ...
                      <div className="bg-ds-muted/50 rounded-lg p-3 text-center">
                        <p className="text-sm font-medium">{new Date(deal.created_at).toLocaleDateString()}</p>
                        <p className="text-xs text-ds-muted-foreground">Created</p>
                      </div>
                    </div>
                  </div>

...
function SettingsPage() {
  ...
  const handleLogout = async () => {
    ...
    try {
      await logout()
      navigate({ to: `/${tenant}/${locale}` as any })
    } finally {
      ...
      <div className="space-y-6">
        ...
        <div className="bg-ds-background rounded-lg border border-ds-border p-6">
          ...
          <Button
            variant="outline"
            size="fit"
            onClick={() => navigate({ to: `/${tenant}/${locale}/reset-password` as any })}
          >
          ...
          {!showDeleteConfirm ? (
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3">
                <Button variant="outline" size="fit" onClick={() => setShowDeleteConfirm(false)}>
                  Cancel
                </Button>

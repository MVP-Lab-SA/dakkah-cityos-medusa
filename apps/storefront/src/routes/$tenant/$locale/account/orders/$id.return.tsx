    ...
    return (
      <AccountLayout>
        <div className="text-center py-12">
          <h1 className="text-2xl font-bold text-ds-foreground mb-2">Order not found</h1>
          <Link to={`/${tenant}/${locale}/account/orders` as any} className="text-ds-info hover:underline">
            View all orders
          </Link>
        </div>
      </AccountLayout>
  ...
  return (
    <AccountLayout>
      <div className="max-w-2xl">
        ...
        <h1 className="text-2xl font-bold text-ds-foreground mb-2">Request a Return</h1>
        ...
        <div className="mt-6 bg-ds-muted rounded-xl p-6">
          <h3 className="font-semibold text-ds-foreground mb-2">Return Policy</h3>

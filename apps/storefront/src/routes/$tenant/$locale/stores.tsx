...
export const Route = createFileRoute("/$tenant/$locale/stores")({
  loader: async ({ params, context }) => {
    const { locale } = params;
    if (typeof window === "undefined") return { locale, region: null, products: [] as HttpTypes.StoreProduct[], categories: [] as HttpTypes.StoreProductCategory[] }
...
function ProductCard({ product }: { product: any }) {
  ...
  return (
    <a
      href={`/${tenant}/${locale}/products/${product.handle}`}

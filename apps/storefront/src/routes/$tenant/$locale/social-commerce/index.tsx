                ...
                {filteredItems.map((item: any) => (
                  ...
                  >
                    <div className="aspect-[4/3] bg-gradient-to-br from-pink-50 to-fuchsia-100 relative overflow-hidden">
                      ...
                      {item.platform && (
                        <span className={`absolute top-2 left-2 px-2.5 py-1 text-xs font-semibold text-white rounded-full capitalize ${platformColors[item.platform?.toLowerCase()] || "bg-gray-600"}`}>

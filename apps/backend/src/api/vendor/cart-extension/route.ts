...
const createSchema = z.object({
  ...
  rule_type: z.enum(["gift_wrap", "delivery_instructions", "bulk_discount", "free_shipping", "add_on", "custom"]).default("custom"),
...
export async function GET(req: MedusaRequest, res: MedusaResponse) {
  ...
  const mod = req.scope.resolve("cartExtension") as any

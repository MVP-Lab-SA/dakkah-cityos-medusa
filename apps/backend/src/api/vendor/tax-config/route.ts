...
const createSchema = z.object({
  ...
  postal_code_pattern: z.string().nullable().optional(),
  tax_rate: z.number(),
...
export async function POST(req: MedusaRequest, res: MedusaResponse) {
  ...
  const item = await mod.createTaxRules({
    ...validation.data,
    vendor_id: vendorId,
  })

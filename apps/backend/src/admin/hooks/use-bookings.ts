...
export function useServiceProviders(params?: { is_active?: boolean; search?: string }) {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const response = await sdk.client.fetch(`/admin/service-providers${query ? `?${query}` : ""}`)
...
export function useUpdateServiceProvider() {
  ...
  return useMutation({
    mutationFn: async ({ id, ...data }: Partial<ServiceProvider> & { id: string }) => {
      const response = await sdk.client.fetch(`/admin/service-providers/${id}`, {
        method: "PUT",
        body: data,
      })
    ...
    onSuccess: (_, variables) => {
      queryClient.invalidateQueries({ queryKey: ["service-providers"] })
      queryClient.invalidateQueries({ queryKey: ["service-providers", variables.id] })
    },
  })
}
...
export function useProviderAvailability(providerId: string) {
  return useQuery({
    ...
    queryFn: async () => {
      const response = await sdk.client.fetch(`/admin/service-providers/${providerId}/availability`)
      return response as { availability: Availability[]; exceptions: AvailabilityException[] }
    },
    enabled: !!providerId,
  })
}
...
export function useUpdateAvailability() {
  ...
  return useMutation({
    mutationFn: async ({ providerId, availability }: { providerId: string; availability: Partial<Availability>[] }) => {
      const response = await sdk.client.fetch(`/admin/service-providers/${providerId}/availability`, {
        method: "PUT",
        body: { availability },
      })
    ...
    onSuccess: (_, variables) => {
      queryClient.invalidateQueries({ queryKey: ["service-providers", variables.providerId, "availability"] })
    },
  })
}
...
export function useAddAvailabilityException() {
  ...
  return useMutation({
    mutationFn: async ({ providerId, ...data }: Partial<AvailabilityException> & { providerId: string }) => {
      const response = await sdk.client.fetch(`/admin/service-providers/${providerId}/availability/exceptions`, {
        method: "POST",
        body: data,
      })
...
export function useBookings(params?: { 
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const query = searchParams.toString()
      const response = await sdk.client.fetch(`/admin/bookings${query ? `?${query}` : ""}`)
...
export function useCompleteBooking() {
  ...
  return useMutation({
    mutationFn: async ({ id, notes }: { id: string; notes?: string }) => {
      const response = await sdk.client.fetch(`/admin/bookings/${id}/complete`, {
        method: "POST",
        body: { notes },
      })
      return response as { booking: Booking }
...
export function useRescheduleBooking() {
  ...
  return useMutation({
    mutationFn: async ({ id, booking_date, start_time, provider_id }: { 
      id: string; 
      booking_date: string; 
      start_time: string;
      provider_id?: string;
    }) => {
      const response = await sdk.client.fetch(`/admin/bookings/${id}/reschedule`, {
        method: "POST",
...
export function useAvailableSlots(params: { 
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const response = await sdk.client.fetch(`/admin/bookings/available-slots?${searchParams.toString()}`)
...
// Booking metrics
export function useBookingMetrics(params?: { date_from?: string; date_to?: string }) {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const query = searchParams.toString()
      const response = await sdk.client.fetch(`/admin/bookings/metrics${query ? `?${query}` : ""}`)

    ...
    if (existingCourseList.length > 0) {
      ...
      const lessons = await Promise.all([
        educationService.createLessons({
          ...
          content_type: "video",
          content_url: "https://learn.dakkah.sa/lessons/dev-setup",
          duration_minutes: 25,
          display_order: 1,
        ...
        educationService.createLessons({
          ...
          content_type: "video",
          content_url: "https://learn.dakkah.sa/lessons/react-fundamentals",
          duration_minutes: 45,
          display_order: 2,
        ...
        educationService.createLessons({
          ...
          content_type: "video",
          content_url: "https://learn.dakkah.sa/lessons/express-apis",
          duration_minutes: 55,
          display_order: 3,
          is_free_preview: false,
          is_mandatory: true,
        ...
        educationService.createLessons({
          ...
          content_type: "video",
          content_url: "https://learn.dakkah.sa/lessons/calligraphy-tools",
          duration_minutes: 20,
          display_order: 1,
          is_free_preview: true,
          is_mandatory: true,
        ...
        educationService.createLessons({
          ...
          content_type: "video",
          content_url: "https://learn.dakkah.sa/lessons/naskh-letters",
          duration_minutes: 40,
          display_order: 2,
          is_free_preview: false,
          is_mandatory: true,

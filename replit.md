...
- **P2 i18n Migration Complete**: Migrated 53 hardcoded placeholder strings + hero titles, badge texts, action buttons, "How It Works" headings across 46+ index pages and 7 additional routes to t(locale,...) calls. Zero hardcoded placeholders remaining in public routes. 176 files now use the t() function. Translation keys added/synced across en.json, fr.json, ar.json (115 namespaces, 2,900+ keys). Common verticals.* namespace created for shared UI strings.
